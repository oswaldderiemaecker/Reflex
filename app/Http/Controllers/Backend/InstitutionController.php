...
class InstitutionController extends Controller {
    ...
    public function getIndex()
    {
        ...
        $grid->edit('/backend/instituciones/edit', 'Editar','modify|delete');
        $grid->link('/backend/instituciones/edit',"Nueva Institución", "TR");
        ...
        {
            return $grid->buildCSV('exportar_instituciones_', 'Y-m-d.His');

        } else {
            $grid->paginate(25);
            return view('backend.institution.grid', compact('filter','grid'));
        }
    }
    ...
    public function anyEdit()
    {
        ...
        $edit->link("/backend/instituciones","Lista Instituciones", "TR")->back();
        ...
        $edit->saved(function () use ($edit) {
            ...
            $edit->link("/backend/instituciones","Regresar");
        });

        return view('backend.institution.modify', compact('edit'));
    }
