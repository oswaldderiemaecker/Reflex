...
class PharmacyController extends Controller {
    ...
    public function getIndex()
    {
        ...
        $grid->edit('/farmacias/edit', 'Editar','modify|delete');
        $grid->link('/farmacias/edit',"Nueva Farmacias", "TR");
        ...
        return  view('pharmacy.grid', compact('filter','grid'));
    }
    ...
    public function anyEdit()
    {
        ...
        $edit->label('Editar Farmacia');
        $edit->link("/farmacias","Lista Farmacias", "TR")->back();
        ...
        $edit->saved(function () use ($edit) {
            ...
            $edit->link("/farmacias","Regresar");
        });

        return view('pharmacy.modify', compact('edit'));
    }
